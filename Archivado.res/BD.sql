...
INSERT INTO usuarios (nombre, contrasenya, privilegio, correo, descripcion) VALUES 
  ("admin", "$2y$10$AazPverunODYkw9LVEKGXOE.lOLBozgbwuoRn/nxt5g5PxmnGNnPq", "1", "admin@1234", "cuenta antigua"),
  ("manolo", "$2y$10$O3563RCxKTjMy9iP5eqIb.BgpE0p0kcrQo1e9yYSPkecSEHBhjPtu", "0", "manolo@patata.com", "cuenta antigua"),
  ("antonio", "$2y$10$Sh9Rgo/hltiQq8v2kb9M0egPa5IZdNYA7JPMpbYodLMfHJHddO5h.", "0", "antonio@sas.com", "cuenta antigua"),
("admin", "$2y$10$JxBe6rhmcs1hwoeYRTOIy.B1xYLmBkg2VzJjlcphpuPp9eagasgcC", "1", "admin@12345678.es", "cuenta antigua");
